...
namespace MinaGroup.Backend.Migrations
{
    ...
    [Migration("20260108162209_AddSelfEvaluationUploadQueueItemModel")]
    partial class AddSelfEvaluationUploadQueueItemModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoogleDriveConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ConnectedAccountEmail")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.GoogleDriveSystemSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GoogleDriveSystemSettings");
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.IntegrationProviderSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.OrganizationStorageIntegration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrganizationStorageIntegrations");
                });
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.SelfEvaluationUploadLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.SelfEvaluationUploadLog", b =>
                {
                    b.HasOne("MinaGroup.Backend.Models.SelfEvaluation", "SelfEvaluation")
                        .WithMany()
            ...
            modelBuilder.Entity("MinaGroup.Backend.Models.Organization", b =>
                {
                    b.Navigation("StorageIntegrations");
